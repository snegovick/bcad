...
def init_display(size=(1024, 768),
                 display_triedron=True,
                 background_gradient_color1=[206, 215, 222],
                 background_gradient_color2=[128, 128, 128], periodic_callback=None, period=None):
    ...
    # Qt based simple GUI
        ...
        class MainWindow(QtWidgets.QMainWindow):
            ...
            def __init__(self, *args):
                ...
                if periodic_callback!=None:
                    self.timer = QtCore.QTimer(self)
                    if period != None:
                        self.timer.start(period)
                    else:
                        self.timer.start(1000)
                    self.timer.timeout.connect(periodic_callback) 
